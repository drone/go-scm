...
func TestGitCreateRef(t *testing.T) {
	...
	client := NewDefault("ORG", "PROJ")
	_, res, err := client.Git.CreateRef(context.Background(), "REPOID", params.Name, params.Sha)
...
func TestGitCompareCommits(t *testing.T) {
	...
	client := NewDefault("ORG", "PROJ")
	got, _, err := client.Git.CompareCommits(context.Background(), "REPOID", "9788e5ddf8b387cb79228628f34d8dc18582d606", "66df312dad61e84dd896d1e8d14ee3dce53b62f0", &scm.ListOptions{})
	if err != nil {
		t.Error(err)
		return
	}
