...
func TestPullGetPRFileDiff(t *testing.T) {
	...
	client := NewDefault()
	got, _, err := client.PullRequests.GetPRFileDiff(context.Background(), "octocat/hello-world", 1347, "asda2")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestPullGetPRFileDiff_NotFound(t *testing.T) {
	...
	client := NewDefault()
	got, _, err := client.PullRequests.GetPRFileDiff(context.Background(), "octocat/hello-world", 1347, "does/not/exist.go")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestPullGetPRFileDiff_Paginated(t *testing.T) {
	...
	client := NewDefault()
	got, _, err := client.PullRequests.GetPRFileDiff(context.Background(), "octocat/hello-world", 1347, "late_file.go")
	if err != nil {
		t.Error(err)
		return
	}
...
func TestPullAddReaction(t *testing.T) {
	...
	client := NewDefault()
	got, res, err := client.PullRequests.AddReaction(context.Background(), "octocat/hello-world", 1347, 1, input)
	if err != nil {
		t.Error(err)
		return
	}
