...
func TestIssueAddReaction(t *testing.T) {
	...
	gock.New("https://gitlab.com").
		Post("/api/v4/projects/diaspora/diaspora/issues/1/notes/1/award_emoji").
	...
	client := NewDefault()
	got, res, err := client.Issues.AddReaction(context.Background(), "diaspora/diaspora", 1, 1, input)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestIssueDeleteReaction(t *testing.T) {
	...
	gock.New("https://gitlab.com").
		Delete("/api/v4/projects/diaspora/diaspora/issues/1/notes/1/award_emoji/344").
		Reply(204).
		Type("application/json").
		SetHeaders(mockHeaders)

	client := NewDefault()
	res, err := client.Issues.DeleteReaction(context.Background(), "diaspora/diaspora", 1, 1, 344)
	if err != nil {
		t.Error(err)
		return
	}
